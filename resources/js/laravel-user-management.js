      ...
      buttons: [
        {
          ...
          text: '<i class="ti ti-logout rotate-n90 me-2"></i>Экспорт',
          buttons: [
            {
              extend: 'print',
              title: 'Users',
        ...
        {
          text: '<i class="ti ti-plus me-0 me-sm-1"></i><span class="d-none d-sm-inline-block">Добавить пользователя</span>',
